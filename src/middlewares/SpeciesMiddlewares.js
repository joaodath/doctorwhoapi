...
const checkEmptyInput = (req, res, next) => {
  ...
  if (
    ...
    !specieCreate.name ||
    !specieCreate.planet ||
    !specieCreate.firstMentioned ||
    !specieCreate.firstAppearance ||
    !specieCreate.lastAppearance ||
    !specieCreate.allAppearances ||
    !specieCreate.bio ||
    !specieCreate.biologicalType ||
    !specieCreate.tardisDataCoreURI ||
    !specieCreate.imgURI
  ) {
    res
      .status(400)
